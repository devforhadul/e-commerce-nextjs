...
export default function Footer() {
  return (
    <footer className="dark:bg-gray-100 dark:text-gray-900">
      <div className="w-11/12 flex flex-col p-4 mx-auto md:p-8 lg:flex-row dark:divide-gray-600">
        ...
        <div className="flex flex-col justify-center pt-6 lg:pt-0">
          <div className="flex justify-center space-x-4">
            ...
            <a rel="noopener noreferrer" href="#" title="Pinterest" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-green-700 dark:text-gray-50">
