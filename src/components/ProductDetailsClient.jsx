  ...
  return (
    <div className="p-4 flex flex-col md:flex-row gap-6 my-5 bg-white rounded-lg">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          {/* Quantity */}
          <div className="">
            <button onClick={() => setQuantity((prev) => Math.max(1, prev - 1))} className="px-3 py-1 bg-gray-200 hover:bg-gray-300">-</button>
            <span className="px-4 py-1">{quantity}</span>
            <button onClick={() => setQuantity(quantity + 1)} className="px-3 py-1 bg-gray-200 hover:bg-gray-300">+</button>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 mt-5">
            ...
            <div className="flex gap-2">
              <button className="px-4 py-2 bg-green-900 text-white rounded-md hover:bg-green-700 transition cursor-pointer">
                Buy Now
              </button>
